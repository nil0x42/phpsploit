"""Base class for PhpSploit shell interfaces.

The following class extends cmdshell, providing core commands, and
PhpSploit specific stuff.
It has been made to serve as a base class to the Main and Remote shells
available in the same directory. Therefore, it must not be loaded by
itself.

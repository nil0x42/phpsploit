...
<pre class="literalblock">
 ...
 Keyword(&quot;if&quot;) will not; it will only match the leading C{'if'} in C{'if x=1'}, or C{'if(y==2)'}
  ...
  string: <code>identChars</code> is a string of characters that would be 
  valid identifier characters, defaulting to all alphanumerics + 
  &quot;_&quot; and &quot;$&quot;; <code>caseless</code> allows 
  case-insensitive matching, default is <code>False</code>.</p>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <span class="summary-sig-arg">identChars</span>=<span class="summary-sig-default"><code class="variable-quote">'</code><code class="variable-string">ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz012345678</code><code class="variable-ellipsis">...</code></span>,
...
<tr><td>
  ...
  <h3 class="epydoc"><span class="sig"><span class="sig-name">__init__</span>(<span class="sig-arg">self</span>,
        ...
        <span class="sig-arg">identChars</span>=<span class="sig-default"><code class="variable-quote">'</code><code class="variable-string">ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz012345678</code><code class="variable-ellipsis">...</code></span>,

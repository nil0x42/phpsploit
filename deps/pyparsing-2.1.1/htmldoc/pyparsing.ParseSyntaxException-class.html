...
<hr />
<p>just like <code><a href="pyparsing.ParseFatalException-class.html" 
  class="link">ParseFatalException</a></code>, but thrown internally when 
  an <code>ErrorStop</code> ('-' operator) indicates that parsing is to 
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="pyparsing.ParseSyntaxException-class.html#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">pe</span>)</span><br />
      x.__init__(...) initializes x; see help(type(x)) for signature</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="pyparsing-pysrc.html#ParseSyntaxException.__init__">source&nbsp;code</a></span>
...
<tr><td>
  ...
  <h3 class="epydoc"><span class="sig"><span class="sig-name">__init__</span>(<span class="sig-arg">self</span>,
        <span class="sig-arg">pe</span>)</span>
